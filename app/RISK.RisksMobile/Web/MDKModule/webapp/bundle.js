...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_Cancel.js":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_Cancel.js ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateEntity.js":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateEntity.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RisksMobile/Services/RISKService.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            'Name': '/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateRISK.js":
/*!***********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateRISK.js ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_DeleteConfirmation.js":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_DeleteConfirmation.js ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DeleteEntity.action').then(
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_UpdateEntity.js":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_UpdateEntity.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_CreateRISK.js":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_CreateRISK.js ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (clientAPI.getODataProvider('/RisksMobile/Services/RISKService.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            ...
            'Properties': {
                ...
                'OnSuccess': '/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action'
            }
        });
    } else {
        return clientAPI.executeAction('/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action');
    }
}

/***/ }),

/***/ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_Edit.js":
/*!**********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_Edit.js ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/RISK/NavToRISK_Edit.js":
/*!********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/RISK/NavToRISK_Edit.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_Cancel.js":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_Cancel.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_CreateEntity.js":
/*!***********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_CreateEntity.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_DeleteConfirmation.js":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_DeleteConfirmation.js ***!
  \*****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RisksMobile/Actions/RISKService/RISK/RISK_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_UpdateEntity.js":
/*!***********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_UpdateEntity.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Initialize(context) {
    ...
    let _RISKService = context.executeAction('/RisksMobile/Actions/RISKService/Service/InitializeOnline.action');

    //You can add more service initialize actions here

    return Promise.all([_RISKService]).then(() => {
...
let risksmobile_actions_riskservice_mitigations_mitigations_createentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action")
let risksmobile_actions_riskservice_mitigations_mitigations_createrisk_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateRISK.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateRISK.action")
let risksmobile_actions_riskservice_mitigations_mitigations_deleteentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/Mitigations_DeleteEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DeleteEntity.action")
let risksmobile_actions_riskservice_mitigations_mitigations_detailpopover_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/Mitigations_DetailPopover.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DetailPopover.action")
let risksmobile_actions_riskservice_mitigations_mitigations_updateentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/Mitigations_UpdateEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_UpdateEntity.action")
let risksmobile_actions_riskservice_mitigations_navtomitigations_create_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Create.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Create.action")
let risksmobile_actions_riskservice_mitigations_navtomitigations_createrisk_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action")
let risksmobile_actions_riskservice_mitigations_navtomitigations_detail_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Detail.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Detail.action")
let risksmobile_actions_riskservice_mitigations_navtomitigations_edit_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Edit.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Edit.action")
let risksmobile_actions_riskservice_mitigations_navtomitigations_list_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_List.action */ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_List.action")
let risksmobile_actions_riskservice_risk_navtorisk_create_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/NavToRISK_Create.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Create.action")
let risksmobile_actions_riskservice_risk_navtorisk_detail_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action")
let risksmobile_actions_riskservice_risk_navtorisk_edit_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/NavToRISK_Edit.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Edit.action")
let risksmobile_actions_riskservice_risk_navtorisk_list_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/NavToRISK_List.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_List.action")
let risksmobile_actions_riskservice_risk_risk_createentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/RISK_CreateEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_CreateEntity.action")
let risksmobile_actions_riskservice_risk_risk_deleteentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/RISK_DeleteEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_DeleteEntity.action")
let risksmobile_actions_riskservice_risk_risk_updateentity_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/RISK/RISK_UpdateEntity.action */ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_UpdateEntity.action")
let risksmobile_actions_riskservice_service_initializeonline_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Service/InitializeOnline.action */ "./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnline.action")
let risksmobile_actions_riskservice_service_initializeonlinefailuremessage_action = __webpack_require__(/*! ./RisksMobile/Actions/RISKService/Service/InitializeOnlineFailureMessage.action */ "./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnlineFailureMessage.action")
...
let risksmobile_pages_riskservice_mitigations_mitigations_create_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_Mitigations/Mitigations_Create.page */ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Create.page")
let risksmobile_pages_riskservice_mitigations_mitigations_createrisk_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_Mitigations/Mitigations_CreateRISK.page */ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_CreateRISK.page")
let risksmobile_pages_riskservice_mitigations_mitigations_detail_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_Mitigations/Mitigations_Detail.page */ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Detail.page")
let risksmobile_pages_riskservice_mitigations_mitigations_edit_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_Mitigations/Mitigations_Edit.page */ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Edit.page")
let risksmobile_pages_riskservice_mitigations_mitigations_list_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_Mitigations/Mitigations_List.page */ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_List.page")
let risksmobile_pages_riskservice_risk_risk_create_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_RISK/RISK_Create.page */ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Create.page")
let risksmobile_pages_riskservice_risk_risk_detail_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_RISK/RISK_Detail.page */ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Detail.page")
let risksmobile_pages_riskservice_risk_risk_edit_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_RISK/RISK_Edit.page */ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Edit.page")
let risksmobile_pages_riskservice_risk_risk_list_page = __webpack_require__(/*! ./RisksMobile/Pages/RISKService_RISK/RISK_List.page */ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_List.page")
...
let risksmobile_rules_riskservice_mitigations_mitigations_cancel_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/Mitigations_Cancel.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_Cancel.js")
let risksmobile_rules_riskservice_mitigations_mitigations_createentity_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateEntity.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateEntity.js")
let risksmobile_rules_riskservice_mitigations_mitigations_createrisk_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateRISK.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateRISK.js")
let risksmobile_rules_riskservice_mitigations_mitigations_deleteconfirmation_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/Mitigations_DeleteConfirmation.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_DeleteConfirmation.js")
let risksmobile_rules_riskservice_mitigations_mitigations_updateentity_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/Mitigations_UpdateEntity.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/Mitigations_UpdateEntity.js")
let risksmobile_rules_riskservice_mitigations_navtomitigations_createrisk_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_CreateRISK.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_CreateRISK.js")
let risksmobile_rules_riskservice_mitigations_navtomitigations_edit_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_Edit.js */ "./build.definitions/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_Edit.js")
let risksmobile_rules_riskservice_risk_navtorisk_edit_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/RISK/NavToRISK_Edit.js */ "./build.definitions/RisksMobile/Rules/RISKService/RISK/NavToRISK_Edit.js")
let risksmobile_rules_riskservice_risk_risk_cancel_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/RISK/RISK_Cancel.js */ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_Cancel.js")
let risksmobile_rules_riskservice_risk_risk_createentity_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/RISK/RISK_CreateEntity.js */ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_CreateEntity.js")
let risksmobile_rules_riskservice_risk_risk_deleteconfirmation_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/RISK/RISK_DeleteConfirmation.js */ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_DeleteConfirmation.js")
let risksmobile_rules_riskservice_risk_risk_updateentity_js = __webpack_require__(/*! ./RisksMobile/Rules/RISKService/RISK/RISK_UpdateEntity.js */ "./build.definitions/RisksMobile/Rules/RISKService/RISK/RISK_UpdateEntity.js")
...
let risksmobile_services_riskservice_service = __webpack_require__(/*! ./RisksMobile/Services/RISKService.service */ "./build.definitions/RisksMobile/Services/RISKService.service")
...
module.exports = {
	...
	risksmobile_actions_riskservice_mitigations_mitigations_createentity_action : risksmobile_actions_riskservice_mitigations_mitigations_createentity_action,
	risksmobile_actions_riskservice_mitigations_mitigations_createrisk_action : risksmobile_actions_riskservice_mitigations_mitigations_createrisk_action,
	risksmobile_actions_riskservice_mitigations_mitigations_deleteentity_action : risksmobile_actions_riskservice_mitigations_mitigations_deleteentity_action,
	risksmobile_actions_riskservice_mitigations_mitigations_detailpopover_action : risksmobile_actions_riskservice_mitigations_mitigations_detailpopover_action,
	risksmobile_actions_riskservice_mitigations_mitigations_updateentity_action : risksmobile_actions_riskservice_mitigations_mitigations_updateentity_action,
	risksmobile_actions_riskservice_mitigations_navtomitigations_create_action : risksmobile_actions_riskservice_mitigations_navtomitigations_create_action,
	risksmobile_actions_riskservice_mitigations_navtomitigations_createrisk_action : risksmobile_actions_riskservice_mitigations_navtomitigations_createrisk_action,
	risksmobile_actions_riskservice_mitigations_navtomitigations_detail_action : risksmobile_actions_riskservice_mitigations_navtomitigations_detail_action,
	risksmobile_actions_riskservice_mitigations_navtomitigations_edit_action : risksmobile_actions_riskservice_mitigations_navtomitigations_edit_action,
	risksmobile_actions_riskservice_mitigations_navtomitigations_list_action : risksmobile_actions_riskservice_mitigations_navtomitigations_list_action,
	risksmobile_actions_riskservice_risk_navtorisk_create_action : risksmobile_actions_riskservice_risk_navtorisk_create_action,
	risksmobile_actions_riskservice_risk_navtorisk_detail_action : risksmobile_actions_riskservice_risk_navtorisk_detail_action,
	risksmobile_actions_riskservice_risk_navtorisk_edit_action : risksmobile_actions_riskservice_risk_navtorisk_edit_action,
	risksmobile_actions_riskservice_risk_navtorisk_list_action : risksmobile_actions_riskservice_risk_navtorisk_list_action,
	risksmobile_actions_riskservice_risk_risk_createentity_action : risksmobile_actions_riskservice_risk_risk_createentity_action,
	risksmobile_actions_riskservice_risk_risk_deleteentity_action : risksmobile_actions_riskservice_risk_risk_deleteentity_action,
	risksmobile_actions_riskservice_risk_risk_updateentity_action : risksmobile_actions_riskservice_risk_risk_updateentity_action,
	risksmobile_actions_riskservice_service_initializeonline_action : risksmobile_actions_riskservice_service_initializeonline_action,
	risksmobile_actions_riskservice_service_initializeonlinefailuremessage_action : risksmobile_actions_riskservice_service_initializeonlinefailuremessage_action,
	...
	risksmobile_pages_riskservice_mitigations_mitigations_create_page : risksmobile_pages_riskservice_mitigations_mitigations_create_page,
	risksmobile_pages_riskservice_mitigations_mitigations_createrisk_page : risksmobile_pages_riskservice_mitigations_mitigations_createrisk_page,
	risksmobile_pages_riskservice_mitigations_mitigations_detail_page : risksmobile_pages_riskservice_mitigations_mitigations_detail_page,
	risksmobile_pages_riskservice_mitigations_mitigations_edit_page : risksmobile_pages_riskservice_mitigations_mitigations_edit_page,
	risksmobile_pages_riskservice_mitigations_mitigations_list_page : risksmobile_pages_riskservice_mitigations_mitigations_list_page,
	risksmobile_pages_riskservice_risk_risk_create_page : risksmobile_pages_riskservice_risk_risk_create_page,
	risksmobile_pages_riskservice_risk_risk_detail_page : risksmobile_pages_riskservice_risk_risk_detail_page,
	risksmobile_pages_riskservice_risk_risk_edit_page : risksmobile_pages_riskservice_risk_risk_edit_page,
	risksmobile_pages_riskservice_risk_risk_list_page : risksmobile_pages_riskservice_risk_risk_list_page,
	...
	risksmobile_rules_riskservice_mitigations_mitigations_cancel_js : risksmobile_rules_riskservice_mitigations_mitigations_cancel_js,
	risksmobile_rules_riskservice_mitigations_mitigations_createentity_js : risksmobile_rules_riskservice_mitigations_mitigations_createentity_js,
	risksmobile_rules_riskservice_mitigations_mitigations_createrisk_js : risksmobile_rules_riskservice_mitigations_mitigations_createrisk_js,
	risksmobile_rules_riskservice_mitigations_mitigations_deleteconfirmation_js : risksmobile_rules_riskservice_mitigations_mitigations_deleteconfirmation_js,
	risksmobile_rules_riskservice_mitigations_mitigations_updateentity_js : risksmobile_rules_riskservice_mitigations_mitigations_updateentity_js,
	risksmobile_rules_riskservice_mitigations_navtomitigations_createrisk_js : risksmobile_rules_riskservice_mitigations_navtomitigations_createrisk_js,
	risksmobile_rules_riskservice_mitigations_navtomitigations_edit_js : risksmobile_rules_riskservice_mitigations_navtomitigations_edit_js,
	risksmobile_rules_riskservice_risk_navtorisk_edit_js : risksmobile_rules_riskservice_risk_navtorisk_edit_js,
	risksmobile_rules_riskservice_risk_risk_cancel_js : risksmobile_rules_riskservice_risk_risk_cancel_js,
	risksmobile_rules_riskservice_risk_risk_createentity_js : risksmobile_rules_riskservice_risk_risk_createentity_js,
	risksmobile_rules_riskservice_risk_risk_deleteconfirmation_js : risksmobile_rules_riskservice_risk_risk_deleteconfirmation_js,
	risksmobile_rules_riskservice_risk_risk_updateentity_js : risksmobile_rules_riskservice_risk_risk_updateentity_js,
	risksmobile_rules_service_initialize_js : risksmobile_rules_service_initialize_js,
	risksmobile_services_riskservice_service : risksmobile_services_riskservice_service,
...
module.exports = {"Controls":[{"FilterFeedbackBar":{"ShowAllFilters":false,"_Type":"Control.Type.FilterFeedbackBar"},"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable","Sections":[{"Header":{"_Name":"SectionHeader_RISKService","AccessoryType":"None","UseTopPadding":true,"Caption":"RISKService","_Type":"SectionCommon.Type.Header"},"Separators":{"TopSectionSeparator":false,"BottomSectionSeparator":true,"HeaderSeparator":true,"FooterSeparator":true,"ControlSeparator":true},"Buttons":[{"OnPress":"/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_List.action","Alignment":"Center","Title":"Mitigations","ButtonType":"Text","Semantic":"Tint","_Type":"ButtonTable.Type.Button"},{"OnPress":"/RisksMobile/Actions/RISKService/RISK/NavToRISK_List.action","Alignment":"Center","Title":"RISK","ButtonType":"Text","Semantic":"Tint","_Type":"ButtonTable.Type.Button"}],"_Name":"SectionButtonTable_RISKService","_Type":"Section.Type.ButtonTable"}]}],"_Name":"Main","_Type":"Page","ActionBar":{"Items":[{"_Name":"ActionBarItem0","Caption":"User Menu","Icon":"sap-icon://customer","Position":"Right","IsIconCircular":false,"Visible":true,"OnPress":"/RisksMobile/Actions/Application/UserMenuPopover.action","_Type":"Control.Type.ActionBarItem"}],"_Name":"ActionBar1","Caption":"Main","PrefersLargeCaption":true,"_Type":"Control.Type.ActionBar"}}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Create.page":
/*!*********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Create.page ***!
  \*********************************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateEntity.js","Position":"Right","SystemItem":"Save","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Create_Mitigations_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"createdAt","_Name":"createdAt","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"createdBy","_Name":"createdBy","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"description","_Name":"description","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"owner","_Name":"owner","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"timeline","_Name":"timeline","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Mitigations_Create"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_CreateRISK.page":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_CreateRISK.page ***!
  \*************************************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Rules/RISKService/Mitigations/Mitigations_CreateRISK.js","Position":"Right","SystemItem":"Save","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Create_RISK)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"title","_Name":"title","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"prio","_Name":"prio","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"descr","_Name":"descr","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"impact","KeyboardType":"Number","_Name":"impact","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"criticality","KeyboardType":"Number","_Name":"criticality","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Mitigations_CreateRISK"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Detail.page":
/*!*********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Detail.page ***!
  \*********************************************************************************************/
/***/ ((module) => {

module.exports = {"DesignTimeTarget":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"Mitigations","QueryOptions":""},"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_Edit.js","Position":"Right","SystemItem":"Edit","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DetailPopover.action","Position":"Right","Caption":"More","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Mitigations_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"ObjectHeader":{"Tags":[],"DetailImage":"","HeadlineText":"{ID}","Subhead":"{createdAt}","BodyText":"","Footnote":"{description}","Description":"{createdBy}","StatusText":"{owner}","StatusImage":"","SubstatusImage":"","SubstatusText":"{timeline}"},"_Type":"Section.Type.ObjectHeader"},{"KeyAndValues":[{"KeyName":"createdAt","Value":"{createdAt}","_Type":"KeyValue.Type.Item"},{"KeyName":"createdBy","Value":"{createdBy}","_Type":"KeyValue.Type.Item"},{"KeyName":"description","Value":"{description}","_Type":"KeyValue.Type.Item"},{"KeyName":"owner","Value":"{owner}","_Type":"KeyValue.Type.Item"},{"KeyName":"timeline","Value":"{timeline}","_Type":"KeyValue.Type.Item"}],"Layout":{"NumberOfColumns":2},"MaxItemCount":1,"_Name":"SectionKeyValue0","_Type":"Section.Type.KeyValue"},{"Header":{"Caption":"RISKS","_Type":"SectionCommon.Type.Header"},"ObjectCell":{"AccessoryType":"DisclosureIndicator","Description":"{descr}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"StatusImage":"","Title":"{title}","Footnote":"{impact}","PreserveIconStackSpacing":false,"StatusText":"{criticality}","Subhead":"{prio}","SubstatusText":"","OnPress":"/RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action","_Type":"ObjectTable.Type.ObjectCell"},"EmptySection":{"Caption":"No record found!"},"Target":{"EntitySet":"{@odata.readLink}/RISKS","Service":"/RisksMobile/Services/RISKService.service"},"_Type":"Section.Type.ObjectTable"}],"DataSubscriptions":["RISK"],"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Mitigations_Detail"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Edit.page":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Edit.page ***!
  \*******************************************************************************************/
/***/ ((module) => {

module.exports = {"DesignTimeTarget":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"Mitigations","QueryOptions":""},"ActionBar":{"Items":[{"Position":"Left","Caption":"Cancel","OnPress":"/RisksMobile/Rules/RISKService/Mitigations/Mitigations_Cancel.js","_Type":"Control.Type.ActionBarItem"},{"Position":"Right","SystemItem":"Save","OnPress":"/RisksMobile/Rules/RISKService/Mitigations/Mitigations_UpdateEntity.js","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Update_Mitigations_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"createdAt","_Name":"createdAt","Value":"{createdAt}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"createdBy","_Name":"createdBy","Value":"{createdBy}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"description","_Name":"description","Value":"{description}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"owner","_Name":"owner","Value":"{owner}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"timeline","_Name":"timeline","Value":"{timeline}","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Mitigations_Edit"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_List.page":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_Mitigations/Mitigations_List.page ***!
  \*******************************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Create.action","Position":"Right","SystemItem":"Add","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Mitigations)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false,"_Type":"SectionCommon.Type.Header"},"ObjectCell":{"AccessoryType":"DisclosureIndicator","Description":"{createdBy}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Detail.action","StatusImage":"","Title":"{ID}","Footnote":"{description}","PreserveIconStackSpacing":false,"StatusText":"{owner}","Subhead":"{createdAt}","SubstatusText":"{timeline}","_Type":"ObjectTable.Type.ObjectCell"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/RISKService.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Mitigations_List"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Create.page":
/*!*******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Create.page ***!
  \*******************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Rules/RISKService/RISK/RISK_CreateEntity.js","Position":"Right","SystemItem":"Save","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Create_RISK_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"title","_Name":"title","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"prio","_Name":"prio","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"descr","_Name":"descr","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"impact","KeyboardType":"Number","_Name":"impact","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"criticality","KeyboardType":"Number","_Name":"criticality","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"RISK_Create"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Detail.page":
/*!*******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Detail.page ***!
  \*******************************************************************************/
/***/ ((module) => {

module.exports = {"DesignTimeTarget":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"RISK","QueryOptions":""},"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Rules/RISKService/RISK/NavToRISK_Edit.js","Position":"Right","SystemItem":"Edit","_Type":"Control.Type.ActionBarItem"},{"OnPress":"/RisksMobile/Rules/RISKService/RISK/RISK_DeleteConfirmation.js","Position":"Right","SystemItem":"Trash","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,RISK_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"ObjectHeader":{"Tags":[],"DetailImage":"","HeadlineText":"{title}","Subhead":"{prio}","BodyText":"","Footnote":"{impact}","Description":"{descr}","StatusText":"{criticality}","StatusImage":"","SubstatusImage":"","SubstatusText":""},"_Type":"Section.Type.ObjectHeader"},{"KeyAndValues":[{"KeyName":"title","Value":"{title}","_Type":"KeyValue.Type.Item"},{"KeyName":"prio","Value":"{prio}","_Type":"KeyValue.Type.Item"},{"KeyName":"descr","Value":"{descr}","_Type":"KeyValue.Type.Item"},{"KeyName":"impact","Value":"{impact}","_Type":"KeyValue.Type.Item"},{"KeyName":"criticality","Value":"{criticality}","_Type":"KeyValue.Type.Item"}],"Layout":{"NumberOfColumns":2},"MaxItemCount":1,"_Name":"SectionKeyValue0","_Type":"Section.Type.KeyValue"}],"DataSubscriptions":[],"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"RISK_Detail"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Edit.page":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_Edit.page ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = {"DesignTimeTarget":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"RISK","QueryOptions":""},"ActionBar":{"Items":[{"Position":"Left","Caption":"Cancel","OnPress":"/RisksMobile/Rules/RISKService/RISK/RISK_Cancel.js","_Type":"Control.Type.ActionBarItem"},{"Position":"Right","SystemItem":"Save","OnPress":"/RisksMobile/Rules/RISKService/RISK/RISK_UpdateEntity.js","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,Update_RISK_Detail)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"title","_Name":"title","Value":"{title}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"prio","_Name":"prio","Value":"{prio}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"descr","_Name":"descr","Value":"{descr}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"impact","_Name":"impact","Value":"{impact}","KeyboardType":"Number","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"criticality","_Name":"criticality","Value":"{criticality}","KeyboardType":"Number","_Type":"Control.Type.FormCell.SimpleProperty"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"RISK_Edit"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_List.page":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/RISKService_RISK/RISK_List.page ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/RISKService/RISK/NavToRISK_Create.action","Position":"Right","SystemItem":"Add","_Type":"Control.Type.ActionBarItem"}],"Caption":"$(L,RISK)","_Type":"Control.Type.ActionBar"},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false,"_Type":"SectionCommon.Type.Header"},"ObjectCell":{"AccessoryType":"DisclosureIndicator","Description":"{descr}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action","StatusImage":"","Title":"{title}","Footnote":"{impact}","PreserveIconStackSpacing":false,"StatusText":"{criticality}","Subhead":"{prio}","SubstatusText":"","_Type":"ObjectTable.Type.ObjectCell"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"RISK","Service":"/RisksMobile/Services/RISKService.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"RISK_List"}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Discard","Target":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Discarded"}},"OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Edit","Target":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Edit"}},"OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}
...
module.exports = {"_Type":"Action.Type.ODataService.DraftEnabled.Save","Target":{"Service":"/RisksMobile/Services/RISKService.service","EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"},"ShowActivityIndicator":true,"ActionResult":{"_Name":"update"},"OnSuccess":{"Name":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","Properties":{"Message":"Draft Saved"}},"OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}
...
/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateEntity.action ***!
  \*******************************************************************************************************/
/***/ ((module) => {

module.exports = {"CreateLinks":[],"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"createdAt":"#Control:createdAt/#Value","createdBy":"#Control:createdBy/#Value","description":"#Control:description/#Value","owner":"#Control:owner/#Value","timeline":"#Control:timeline/#Value"},"Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/RISKService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateRISK.action":
/*!*****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_CreateRISK.action ***!
  \*****************************************************************************************************/
/***/ ((module) => {

module.exports = {"ParentLink":{"Property":"RISKS","Target":{"EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"}},"OnFailure":"/RisksMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RisksMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"title":"#Control:title/#Value","prio":"#Control:prio/#Value","descr":"#Control:descr/#Value","impact":"#Control:impact/#Value","criticality":"#Control:criticality/#Value"},"Target":{"EntitySet":"RISK","Service":"/RisksMobile/Services/RISKService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateRelatedEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DeleteEntity.action":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DeleteEntity.action ***!
  \*******************************************************************************************************/
/***/ ((module) => {

module.exports = {"Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/RISKService.service","ReadLink":"{@odata.readLink}"},"OnSuccess":"/RisksMobile/Actions/DeleteEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/DeleteEntityFailureMessage.action","ActionResult":{"_Name":"delete"},"_Type":"Action.Type.ODataService.DeleteEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DetailPopover.action":
/*!********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_DetailPopover.action ***!
  \********************************************************************************************************/
/***/ ((module) => {

module.exports = {"PopoverItems":[{"Title":"Add RISK","OnPress":"/RisksMobile/Rules/RISKService/Mitigations/NavToMitigations_CreateRISK.js"},{"Title":"Delete","OnPress":"/RisksMobile/Rules/RISKService/Mitigations/Mitigations_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_UpdateEntity.action":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/Mitigations_UpdateEntity.action ***!
  \*******************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Mitigations","Service":"/RisksMobile/Services/RISKService.service","ReadLink":"{@odata.readLink}"},"Properties":{"createdAt":"#Control:createdAt/#Value","createdBy":"#Control:createdBy/#Value","description":"#Control:description/#Value","owner":"#Control:owner/#Value","timeline":"#Control:timeline/#Value"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Create.action":
/*!******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Create.action ***!
  \******************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action":
/*!**********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_CreateRISK.action ***!
  \**********************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RISKService_Mitigations/Mitigations_CreateRISK.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Detail.action":
/*!******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Detail.action ***!
  \******************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Detail.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Edit.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_Edit.action ***!
  \****************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RISKService_Mitigations/Mitigations_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_List.action":
/*!****************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Mitigations/NavToMitigations_List.action ***!
  \****************************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/RISKService_Mitigations/Mitigations_List.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Create.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Create.action ***!
  \****************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RISKService_RISK/RISK_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Detail.action ***!
  \****************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/RISKService_RISK/RISK_Detail.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Edit.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_Edit.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/RISKService_RISK/RISK_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_List.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/NavToRISK_List.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/RISKService_RISK/RISK_List.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_CreateEntity.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_CreateEntity.action ***!
  \*****************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_DeleteEntity.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_DeleteEntity.action ***!
  \*****************************************************************************************/
/***/ ((module) => {

module.exports = {"Target":{"EntitySet":"RISK","Service":"/RisksMobile/Services/RISKService.service","ReadLink":"{@odata.readLink}"},"OnSuccess":"/RisksMobile/Actions/DeleteEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/DeleteEntityFailureMessage.action","ActionResult":{"_Name":"delete"},"_Type":"Action.Type.ODataService.DeleteEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_UpdateEntity.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/RISK/RISK_UpdateEntity.action ***!
  \*****************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"RISK","Service":"/RisksMobile/Services/RISKService.service","ReadLink":"{@odata.readLink}"},"Properties":{"title":"#Control:title/#Value","prio":"#Control:prio/#Value","descr":"#Control:descr/#Value","impact":"#Control:impact/#Value","criticality":"#Control:criticality/#Value"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnline.action":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnline.action ***!
  \*******************************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/RisksMobile/Services/RISKService.service","_Type":"Action.Type.ODataService.Initialize","ShowActivityIndicator":true,"OnFailure":"/RisksMobile/Actions/RISKService/Service/InitializeOnlineFailureMessage.action","ActionResult":{"_Name":"init"}}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnlineFailureMessage.action":
/*!*********************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/RISKService/Service/InitializeOnlineFailureMessage.action ***!
  \*********************************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Services/RISKService.service":
/*!********************************************************************!*\
  !*** ./build.definitions/RisksMobile/Services/RISKService.service ***!
  \********************************************************************/
/***/ ((module) => {

module.exports = {"DestinationName":"../service/RISKService/","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{},"OfflineOptions":{},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
